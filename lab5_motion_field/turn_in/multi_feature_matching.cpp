...
#define templateXSize 49
#define templateYSize 49

#define searchXSize 79
#define searchYSize 79
...
void multiFrameTrack(int start, int end, VideoWriter Vout, string fileBase, string outImgName, string endImgName);
...
void multiFrameTrack(int start, int end, VideoWriter Vout, string fileBase, string outImgName, string endImgName){
	...
	// Load in the previous image and the current image. We take the template from source and try to match it to compareImg. 
		...
		findFundamentalMat(points[0], points[1], CV_FM_RANSAC, 1, 0.99, status);
...
// This is made into a function so I can call many different images sets easily. 
	...
	multiFrameTrack(start, end, Vout, "parallel_real/ParallelReal", "outParaRealStart.jpg", "outParaRealEnd.jpg");
	multiFrameTrack(start, end, Vout, "turned_real/TurnReal", "outTurnRealStart.jpg", "outTurnRealEnd.jpg");
	multiFrameTrack(start, end, Vout, "parallel_cube/ParallelCube", "outParaCubeStart.jpg", "outParaCubeEnd.jpg");
	multiFrameTrack(start, end, Vout, "turned_cube/TurnCube", "outTurnCubeStart.jpg", "outTurnCubeEnd.jpg");
